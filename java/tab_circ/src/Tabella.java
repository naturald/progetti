public class Tabella
{
    ...
    {
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println("| "+strLen("Circ",4)+" | "+strLen("relazione",10)+" | "+strLen("tra quali R",10)+" | "+strLen("comp I",15)+" | "+strLen("comp V",15)+" | "+strLen("Rxy",6)+" |");
        System.out.println("--------------------------------------------------------------------------------");
        for(Voci i : contenuto)
        {
            if(i != null)
            {
                System.out.print("| " + strLen(i.nCirc+"",4) + " | " + strLen(i.tipoCon,10) + " | " + strLen(i.tra_r[0] + "," + i.tra_r[1],11)+ " | " + strLen(i.compV ,15)+ " | " + strLen(i.compI,15) + " | " + strLen((Math.floor(i.Rxy * 100) / 100)+"",6) + " | \n");
                System.out.println("--------------------------------------------------------------------------------");
            }
        }
    }
    public void stamRes(Resistenza[] res)
    {
        ...
        System.out.println("| "+strLen("Nome",4)+" | "+strLen("Valo",4)+" |");
        System.out.println("o------o------o");
        for(Resistenza i : res)
            if(i != null)
            {
                System.out.println("| " + strLen(i.getNome(), 4) + " | " + strLen(i.getValore() + "", 4) + " |");
                System.out.println("o------o------o");
            }
    }
