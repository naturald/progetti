...
<body>
        ...
        <div id="login" class="modal">
            <div id="con_login" class="con_modal" > 
                ...
                <form name="sign_up" action="elogin.php" method="POST">
                <center>
                ...
                <center>
                    <input type="text"  class="dati" style="margin-bottom: 20px;" onkeyup="contr_lung()" id="cognome" name="cognome"  placeholder="Cognome">
                </center>
            ...
            <div id="con_sign_up" class="con_modal_sign_in" > 
                ...
                <center>
                    <input type="text"  class="dati" style="margin-bottom: 20px;" onkeyup="contr_lung_sign()" id="mail" name="mail" placeholder="Mail">
                </center>
